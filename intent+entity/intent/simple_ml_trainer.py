...
class IntentClassifierTrainer:
    """Clean ML trainer for intent classification only (no entity extraction)"""
    ...
    def prepare_features(self, train_df, val_df, test_df):
        """Extract optimized TF-IDF features from text"""
        print("\n🔧 Extracting optimized TF-IDF features...")
        ...
        self.vectorizer = TfidfVectorizer(
            ...
            min_df=1,  # Include all features for small dataset
            max_df=0.95,  # Remove very frequent terms
    ...
    def train_models(self, X_train, y_train, X_val, y_val):
        ...
        # Define optimized models to test
        models = {
...
def main():
    """Main training pipeline for intent classification only"""
    print("🚀 INTENT CLASSIFICATION TRAINING - CLEAN & FOCUSED")
    print("=" * 60)
    print("Focus: Intent prediction only (no entity extraction)")
    print()
    ...
    try:
        ...
        print("🎉 INTENT CLASSIFICATION TRAINING COMPLETE!")
        print(f"Final Test Accuracy: {final_results['accuracy']:.4f}")
        print(f"Final Test F1 Score: {final_results['f1_weighted']:.4f}")
        print("\n✅ Model ready for intent prediction only!")
        
    except FileNotFoundError as e:
        print("❌ Error: Required files not found. Please run prepare_intent_data.py first.")
